...
namespace Application.Patients
{
    public class PatientValidator : AbstractValidator<PatientDto>
    {
        public PatientValidator()
        {
            ...
            RuleFor(d => d.Residence).NotEmpty().Length(10,50).WithMessage("Residence field is required.");
            ...
            RuleFor(d => d.Gender).NotEmpty().Length(6,50).WithMessage("Gender field is required.");
            RuleFor(d => d.BloodGroup).NotEmpty().Length(4,50).WithMessage("BloodGroup field is required.");
